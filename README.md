...
<head>
  ...
  <meta name="description" content="Mobil öncelikli CV & Portfolyo" />
  <style>
    :root{
      --bg:#0b1020;
    ...
    *{box-sizing:border-box}
    ...
    /* Desktop enhancements only (optional) */
...
<body>
  <div class="wrap">
    ...
    <div class="drawer" id="drawer" aria-hidden="true">
      ...
      <div class="sheet card">
        ...
        <div class="menu">
          ...
          <a href="#projects" class="mLink">Projeler</a>
    ...
    <section id="about" class="section card reveal">
      <h2>Hakkımda</h2>
      <p class="p">
        Buraya kısa ve etkili bir “kimim / ne yapıyorum / ne arıyorum” paragrafı gelecek.
        Bilgilerini atınca ben bunu profesyonel ve vurucu bir şekilde yazıp yerleştiririm.
      </p>
    </section>
    ...
    <section id="edu" class="section card reveal">
      ...
      <div class="timeline">
        <div class="tItem">
          ...
          <p class="tMeta">2024 – Devam • İstanbul</p>
          <p class="tDesc">Odak: kontrol sistemleri, sayısal devreler, gömülü sistemler (senin detayın gelince düzeltirim).</p>
        </div>
        <div class="tItem">
          <span class="tDot"></span><span class="tLink"></span>
          <p class="tTitle">Lise / Diğer Okul</p>
          <p class="tMeta">Yıl aralığı • Şehir</p>
          <p class="tDesc">Kulüp / proje / başarı (1-2 satır).</p>
        </div>
      </div>
    </section>
    ...
    <section id="projects" class="section card reveal">
      ...
      <div class="timeline">
        <div class="tItem">
          <span class="tDot"></span><span class="tLink"></span>
          <p class="tTitle">Proje Adı — Rol</p>
          <p class="tMeta">Teknolojiler: ESP32, Arduino, Python, …</p>
          <p class="tDesc">Ne yaptın, çıktısı ne, varsa metrik/ödül/link.</p>
        </div>
        <div class="tItem">
          <span class="tDot"></span><span class="tLink"></span>
          <p class="tTitle">Proje Adı 2</p>
          <p class="tMeta">Teknolojiler: …</p>
          <p class="tDesc">Kısa açıklama.</p>
        </div>
      </div>
    </section>
    ...
    <section id="skills" class="section card reveal">
      ...
      <div class="chips">
        ...
        <span class="chip">CAD / Tasarım</span>
      </div>
    </section>
    ...
    <section id="contact" class="section card reveal">
      ...
      <p class="p">
        ...
        LinkedIn: <a href="https://linkedin.com/in/USERNAME" target="_blank" rel="noreferrer">@USERNAME</a><br/>
